            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <c:if test="${not empty user}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/eletronico/lista">Eletronico</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/movel/lista">Movel</a>
                        </li>
                        <li class="nav-item">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <c:if test="${not empty user}">
                        <li><a href="/logout"><span class="glyphicon glyphicon-log-out"></span> Logout ${user.nome}</a>
                        </li>
                    </c:if>
                </ul>
            </div>
